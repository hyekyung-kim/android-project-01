...
public class RecordAdapter extends BaseAdapter {
    ...
    public RecordAdapter(Context context, int layout, ArrayList<BookDTO> bookDataList){
    ...
    public View getView(int pos, View convertView, ViewGroup viewGroup){
        ...
        if(convertView == null){
            ...
            viewHolder.imgView = view.findViewById(R.id.img_book);
            viewHolder.tvStartDay = view.findViewById(R.id.startDate);
            viewHolder.tvEndDay = view.findViewById(R.id.endDate);
        ...
        viewHolder.tvEndDay.setText(dto.getEndDay());
...
//        파일에서 이미지 파일을 읽어온 결과에 따라 파일 이미지 사용 또는 네트워크 다운로드 수행
    ...
    class GetImageAsyncTask extends AsyncTask<String, Void, Bitmap> {
        ...
        public GetImageAsyncTask(RecordViewHolder holder) {
            viewHolder = holder;
        }
