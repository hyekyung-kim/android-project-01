...
public class SearchAdapter  extends BaseAdapter {
    ...
    public SearchAdapter(Context context, int resource, ArrayList<NaverBookDTO> list) {
...
//        dto 에 기록한 이미지 주소를 사용하여 이미지 파일을 읽어오기 수행
        Bitmap savedBitmap = imageFileManager.getSavedBitmapFromInternal(dto.getImageLink(), 0);
